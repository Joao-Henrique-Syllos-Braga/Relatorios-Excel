...
from main import data  # Certifique-se de que o arquivo `main.py` está correto e no mesmo diretório
...
for col in range(2, len(data()[0]) + 1):  # Ajustando as colunas a partir da segunda
...
last_col = len(data()[0])  # Encontrar o número da última coluna
...
# Definir a formatação para a primeira linha
header_row = sheet[1]
